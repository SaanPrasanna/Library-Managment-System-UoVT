...
namespace LMS {
    public partial class MembersActionsForm : Form {
        ...
        private void LoadData(string mid) {
            ...
            conn.Open();
            try {
                string query = "SELECT fname, lname, address, category  FROM members WHERE mid = @mid;";
            ...
            if (MIDTb.Text != string.Empty && FnameTb.Text != string.Empty && LnameTb.Text != string.Empty
                ...
                if (ActionBtn.Text == "ADD MEMBER") {
                    ...
                    try {
                        ...
                        cmd.Parameters.Add("@renewDate", SqlDbType.Date).Value = DateTime.Now.AddDays(365).ToString("yyyy-MM-dd");
